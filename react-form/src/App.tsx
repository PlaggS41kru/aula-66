      ...
      <main>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <fieldset>
            ...
            <input type="text" id="room" {...register("name", {required: "Laboratório obrigatório"})} />
            {errors.room && <p>{errors.room.message}</p>}
          </fieldset>

          <fieldset>
            <label htmlFor="capacity">Capacidade máxima</label>
            <input type="number"  id="capacity" {...register("capacity", {required: "Capacidade obrigatória"})} />
            {errors.capacity && <p>{errors.capacity.message}</p>}
          </fieldset>

          <fieldset>
            <label htmlFor="day">Dia</label>
            <input type="text"  id="day" {...register("day", {required: "Dia obrigatório"})} />
            {errors.day && <p>{errors.day.message}</p>}
          </fieldset>

          <fieldset>
            <label htmlFor="hour">Hora</label>
            <input type="time" id="hour" {...register("hour", {required: "Hora obrigatório"})} />
